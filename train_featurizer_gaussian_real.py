...
# python -m train.train_featurizer_gaussian --exp delete --lr 1e-3 --num_per_convo 128 --batch_size 512 --embedding_size 512
        ...
        def generate_data(self):
            ...
            for _ in range(self.num_samples):
                if np.random.rand() > 0.5:
                    sample = np.random.normal(self.mean1, self.std1, size = (2048,))  # Generate a sample with 512 dimensions
                    label = 0  # Label 0 for the first Gaussian dataset
                else:
                    sample = np.random.normal(self.mean2, self.std2, size = (2048,))  # Generate a sample with 512 dimensions
