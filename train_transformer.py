...
if __name__ == '__main__':
    ...
    featurizer_checkpoint = torch.load('/raid/lingo/martinrm/automatic-annotation/src/featurizer/ckpts/train_with_feautirizer_22_9_23_try_two/checkpoint.pth.tar')
    ...
    for epoch in range(args.epoch):
        ...
        for i_batch, sample_batched in enumerate(train_dataloader):
            print(np.round(100*i_batch/len(train_dataloader)))
